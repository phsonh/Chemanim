...
const json& registry() {
    static const json value = json::array({
        ...
        definition("adornment_set_offset", "设定标记坐标", "分子", "标记", {field("target","分子","molecule",""),field("adornment","标记 ID","text",""),field("x","本地 X","float",0),field("y","本地 Y","float",0)}),
        definition("adornment_lerp_offset", "插值标记坐标", "分子", "标记", {field("target","分子","molecule",""),field("adornment","标记 ID","text",""),field("x","目标本地 X","float",0),field("y","目标本地 Y","float",0),field("frames","帧数","int",30),field("easing","缓动","easing","linear")}),
        definition("adornment_set_alpha", "设定标记透明度", "分子", "标记", {field("target","分子","molecule",""),field("adornment","标记 ID","text",""),field("value","Alpha","alpha",255)}),
        definition("adornment_lerp_alpha", "插值标记透明度", "分子", "标记", {field("target","分子","molecule",""),field("adornment","标记 ID","text",""),field("value","目标 Alpha","alpha",255),field("frames","帧数","int",30),field("easing","缓动","easing","linear")}),
        definition("adornment_set_color", "设定标记颜色", "分子", "标记", {field("target","分子","molecule",""),field("adornment","标记 ID","text",""),field("r","R","byte",0),field("g","G","byte",0),field("b","B","byte",0)}),
        definition("adornment_lerp_color", "插值标记颜色", "分子", "标记", {field("target","分子","molecule",""),field("adornment","标记 ID","text",""),field("r","目标 R","byte",0),field("g","目标 G","byte",0),field("b","目标 B","byte",0),field("frames","帧数","int",30),field("easing","缓动","easing","linear")}),
        definition("adornment_set_text", "设定标记文字", "分子", "标记", {field("target","分子","molecule",""),field("adornment","标记 ID","text",""),field("value","文字","text","+")}),
