...
chem.SetGlobal("arrow", "r", 190)
chem.SetGlobal("arrow", "g", 45)
chem.SetGlobal("arrow", "b", 35)
...
molecule2.SetPos(3.5527136788e-15, 2.36847578587e-15)
...
molecule2:SetStructure({
    ...
    reference_bond_length = 32,
    atoms = {
        { id="A7", creation_serial=7, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=3, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=-32, y=4.73695157173e-15 },
        { id="A8", creation_serial=8, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=0, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=-2.36847578587e-15, y=-3.17315587058e-16 },
        { id="A9", creation_serial=9, element="O", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=0, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=32, y=-4.73695157173e-15 },
    },
    bonds = {
        ...
        { id="B8", a="A8", b="A9", order=3, secondary_line_side="center", stereo="none", visible=true, alive=true, alpha=255, color_r=0, color_g=0, color_b=0 },
    },
    adornments = {
        { id="D1", creation_serial=10, atom="A9", text="⊕", x=18, y=18, alpha=255, color_r=0, color_g=0, color_b=0, alive=true },
    }
})
...
molecule3:SetStructure({
    ...
    atoms = {
        ...
        { id="A16", creation_serial=17, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=3, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=138, y=4.73695157173e-15 },
        { id="A17", creation_serial=18, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=0, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=170, y=-3.17315587058e-16 },
        { id="A18", creation_serial=19, element="O", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=0, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=202, y=-4.73695157173e-15 },
    },
    bonds = {
        ...
        { id="B16", a="A17", b="A18", order=3, secondary_line_side="center", stereo="none", visible=true, alive=true, alpha=255, color_r=0, color_g=0, color_b=0 },
    },
    adornments = {
        { id="D2", creation_serial=20, atom="A18", text="⊕", x=18, y=18, alpha=255, color_r=0, color_g=0, color_b=0, alive=true },
    }
})
...
molecule3:LerpStructure({
    ...
    atoms = {
        ...
        { id="A14", creation_serial=15, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=1, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=-16, y=27.7128129211 },
        { id="A15", creation_serial=16, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=1, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=16, y=27.7128129211 },
        { id="A16", creation_serial=17, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=3, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=80, y=-27.7128129211 },
        { id="A17", creation_serial=18, element="C", label="", label_side="right", number_style="subscript", isotope=0, radical_electrons=0, implicit_hydrogens=0, hidden=false, alive=true, alpha=255, color_r=0, color_g=0, color_b=0, x=64, y=3.29431468357e-15 },
    ...
    bonds = {
        ...
        { id="B12", a="A13", b="A14", order=2, secondary_line_side="right", stereo="none", visible=true, alive=true, alpha=255, color_r=0, color_g=0, color_b=0 },
        { id="B13", a="A14", b="A15", order=1, secondary_line_side="center", stereo="none", visible=true, alive=true, alpha=255, color_r=0, color_g=0, color_b=0 },
        { id="B14", a="A15", b="A10", order=1, secondary_line_side="right", stereo="none", visible=true, alive=true, alpha=255, color_r=0, color_g=0, color_b=0 },
        { id="B15", a="A16", b="A17", order=1, secondary_line_side="center", stereo="none", visible=true, alive=true, alpha=255, color_r=0, color_g=0, color_b=0 },
    ...
    adornments = {
        { id="D3", creation_serial=990101, atom="A15", text="⊕", x=18, y=18, alpha=255, color_r=0, color_g=0, color_b=0, alive=true },
    }
}, 30, "linear")
